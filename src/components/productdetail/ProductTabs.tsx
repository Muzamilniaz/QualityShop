    ...
    <div className="lg:w-full">
        <nav className=" ">
            <div className="nav nav-tabs mb-3 flex border-b-2">
                <button
                    className={`nav-link bg-transparent  border-0  border-b-2 text-brand-heading_primary  font-medium   py-2 px-4 transition duration-500 ${activetab === "description"
                ...
                <button
                    className={`nav-link bg-transparent border-0 border-b-2 text-brand-heading_primary py-2 font-medium px-4 transition duration-500 ${activetab === "reviews"
                            ? "border-brand-secondary"
                            : "text-brand-primary"
                        }`}
                    type="button"
        ...
        <div className="tab-content mb-5">
            {activetab === "description" ? (
                ...
                >
                    {reviews.map((review) => (
                        <div key={review.reviewerName} className="flex items-start gap-4 mb-4">
                            {/* Avatar */}
